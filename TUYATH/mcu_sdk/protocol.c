...
void all_data_update(void)
{
    ...
    mcu_dp_value_update(DPID_HUMIDITY_VALUE,0); //VALUE型数据上报;
    mcu_dp_enum_update(DPID_BATTERY_STATE,0); //枚举型数据上报;
    mcu_dp_value_update(DPID_BATTERY_PERCENTAGE,0); //VALUE型数据上报;
    mcu_dp_bool_update(DPID_TAMPER_ALARM,0); //BOOL型数据上报;
    mcu_dp_value_update(DPID_TEMP_SAMPLING,0); //VALUE型数据上报;
    mcu_dp_value_update(DPID_HUMIDITY_SAMPLING,0); //VALUE型数据上报;
    mcu_dp_bool_update(DPID_CHARGE_STATE,0); //BOOL型数据上报;
    mcu_dp_enum_update(DPID_TEMP_UNIT_CONVERT,0); //枚举型数据上报;
    mcu_dp_value_update(DPID_MAXTEMP_SET,0); //VALUE型数据上报;
    mcu_dp_value_update(DPID_MINITEMP_SET,0); //VALUE型数据上报;
    mcu_dp_value_update(DPID_MAXHUM_SET,0); //VALUE型数据上报;
    mcu_dp_value_update(DPID_MINIHUM_SET,0); //VALUE型数据上报;
    mcu_dp_enum_update(DPID_TEMP_ALARM,0); //枚举型数据上报;
    mcu_dp_enum_update(DPID_HUM_ALARM,0); //枚举型数据上报;
    mcu_dp_value_update(DPID_BRIGHT_VALUE,0); //VALUE型数据上报;
    mcu_dp_value_update(DPID_TEMP_PERIODIC_REPORT,0); //VALUE型数据上报;
    mcu_dp_value_update(DPID_HUM_PERIODIC_REPORT,0); //VALUE型数据上报;
    mcu_dp_value_update(DPID_TEMP_SENSITIVITY,0); //VALUE型数据上报;
    mcu_dp_value_update(DPID_HUM_SENSITIVITY,0); //VALUE型数据上报;
    mcu_dp_bool_update(DPID_SWITCH,0); //BOOL型数据上报;
    mcu_dp_value_update(DPID_TEMP_SET,0); //VALUE型数据上报;
